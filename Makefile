...
.PHONY: setup doctor doctor-tls build up down logs reset test test-lws test-l3 test-typeindex test-indexed-relation test-mcp-v2 test-profiles test-projection publish-profiles test-app test-app-e2e shell cert up-tls down-tls cid-tls up-fork-tls down-fork-tls
