...
export async function probeCapabilities(base = BASE) {
  ...
  const j = async (u, h = {}) =>
    fetch(u, { headers: h }).then((r) => (r.ok ? r.json() : null)).catch(() => null)
